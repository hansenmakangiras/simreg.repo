...
class Auth extends Admin_Controller
{
    ...
    function index()
    {
        ...
        if (!$this->ion_auth->logged_in()) {
            ...
            return show_error('Hanya administrator yang berhak mengakses halaman ini.');
        } else {
            ...
            $this->_render_page('admin/_layout_main', $this->data);
        }
    }
    ...
    function login()
    {
        ...
        if ($this->form_validation->run() == true) {
            ...
            $this->_render_page('admin/layout_login', $this->data);
        }
    }
